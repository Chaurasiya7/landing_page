...
function Navbar() {
  ...
  return (
    <div className='text-white flex justify-between items-center h-24 mx-auto max-w-[1200px] px-7'>
      <h1 className='w-full text-3xl font-bold text-[#7000df]'>REACT</h1>
      ...
      <div className={!nav ? "fixed left-0 top-0 w-[60%] border-r border-r-gray-800 h-full bg-[#000300] ease-in-out duration-500" : 'fixed left-[-100%]'}>
      <h1 className='w-full text-3xl font-bold text-[#7000df] mx-7 mt-7'>REACT</h1>
      <ul className='p-4 '>
